...
class Wind {
    ...
    getNoiseVector() {
        ...
        return p.createVector(p.map(p.noise(this.noiseOffset.x), 0, 1, -this.strength, this.strength), p.map(p.noise(this.noiseOffset.y), 0, 1, -this.strength, this.strength));
    }
    getNormalVector() {
